...
#define SIG ((1) / (-1(--z)); //Sigmoid used as output EXPERIMENTAL, for track and trace or simply tx and rx for xyz calc in 3rd and or 4th Dimension (Time).
...
float main (float argc, char **argv) {
    ...
    printf('Speed is: %f', speed); //Partial derivative
